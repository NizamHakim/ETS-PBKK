...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            <div class="alert alert-danger my-2"><?php echo e($message); ?></div>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="3" value="<?php echo e(old('keterangan')); ?>"></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="kecacatan" name="kecacatan" rows="3" value="<?php echo e(old('kecacatan')); ?>"></textarea>
                    </div>
                    
                    <div class="mb-3">
                        <label for="jumlah" class="form-label">Jumlah Barang</label>
                        <input type="number" class="form-control" id="jumlah" name="jumlah" placeholder="Jumlah Barang" value="<?php echo e(old('jumlah')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="image" name="image" accept="image/*" value="<?php echo e(old('image')); ?>">
...
</html><?php /**PATH C:\laragon\www\ets\resources\views/items/create.blade.php ENDPATH**/ ?>